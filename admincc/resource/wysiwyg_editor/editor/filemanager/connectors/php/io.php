...
function SendUploadResults( $errorNumber, $fileUrl = '', $fileName = '', $customMsg = '' )
{
	...
	$rpl = array( '\\' => '\\\\', '"' => '\\"' ) ;
   //echo '<script>console.log(window);</script>';exit();
	echo '<script>parents.OnUploadCompleted(' . $errorNumber . ',"' . strtr( $fileUrl, $rpl ) . '","' . strtr( $fileName, $rpl ) . '", "' . strtr( $customMsg, $rpl ) . '"); </script>' ;
	exit ;
}
