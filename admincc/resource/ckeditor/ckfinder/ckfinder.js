...
(function () {
    ...
    (function () {
        ...
        CKFinder.lang = {};
        CKFinder.version = '2.2';
        CKFinder.revision = '2202';
    ...
    (function () {
        ...
        a.nd = "\x6c\157";
        a.jG = "\x68\157";
        a.hf = new window["\122\x65\147\x45\170\x70"]("\x5e\167\x77\x77\134\x2e");
        a.hg = new window["\x52\145\147\105\170\160"]("\x3a\x5c\144\x2b\x24");
        a.lS = function (q) {
            ...
            bz: function (q) {
                q.on('appReady', function () {
                    ...
                    q.connector.sendCommand('Init', s, function (t) {
                        ...
                        var v = "\x43\157\156\x6e\145\143\164\157\x72\057\103\157\x6e\x6e\x65\143\164\x6f\x72\x49\x6e\x66\x6f\x2f";
                        a.ed = t.selectSingleNode(v + "\100\163").value;
                        a.bF = t.selectSingleNode(v + "\x40\143").value + '----';
                        q.config.thumbsEnabled = t.selectSingleNode(v + "\100\164\150\165\x6d\x62\163\105\x6e\141\x62\x6c\x65\144").value == 'true';
                        q.config.thumbsDirectAccess = false;
                        if (q.config.thumbsEnabled) {
                            u = t.selectSingleNode(v + "\x40\164\x68\x75\x6d\142\x73\125\x72\x6c");
                            if (u) q.config.thumbsUrl = u.value;
                            u = t.selectSingleNode(v + "\100\164\x68\x75\155\142\x73\x44\151\x72\x65\143\164\x41\143\143\x65\163\163");
                            if (u) q.config.thumbsDirectAccess = u.value == 'true';
                        }
                        q.config.imagesMaxWidth = parseInt(t.selectSingleNode(v + "\100\151\x6d\147\127\x69\144\164\x68").value, 10);
                        q.config.imagesMaxHeight = parseInt(t.selectSingleNode(v + "\x40\x69\x6d\x67\x48\145\151\147\x68\x74").value, 10);
                        u = t.selectSingleNode(v + "\100\x75\160\x6c\x6f\141\144\115\x61\170\x53\151\172\x65");
                        q.config.uploadMaxSize = u ? parseInt(u.value, 10) : 0;
                        u = t.selectSingleNode(v + "\100\165\x70\x6c\x6f\141\144\x43\150\145\143\153\x49\155\x61\x67\x65\x73");
                        q.config.uploadCheckImages = u ? u.value == 'true' : false;
                        var w = t.selectSingleNode(v + "\100\x70\x6c\x75\x67\x69\156\163"),
                            x = w && w.value;
                ...
                this.oW('beforeAddFolder', B, function M(D, E) {
                    ...
                    try {
                        if (G) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\x63\x61\x74\x69\157\156"][a.jG + "\163\x74"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function () {
                                A.app.layout.ea();
                            }, 100);
                        }
    ...
    (function () {
        ...
        var u = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'],
            v = ['Node', "\x6d\x65\163\163\x61\x67\x65"];

        function w(G) {
            var H = v.reverse().join(''),
                I = G.tools.of(),
                J = I['se' + "\164\x48\164\x6d\x6c"];
            J.call(I, G.qX());
                    ...
                    if (G.eU) {
                        ...
                        G.eU({
                            selectFile: {
                                label: G.lang.Select,
                                onClick: function () {
                                    var N = G.aG['filesview.filesview'],
                                        O = N.tools.dH();
        ...
        function y() {
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "\143\x61\x74\x69\157\x6e"][a.jG + "\x73\x74"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
        ...
        function z() {
            var G = a.aG.hS('filesview', 'filesview', {
                ...
                //H = "\x50\154\x65\x61\163\x65\040\166\x69\x73\x69\x74\x20\x74\x68\145\040\074\141\x20\x68\162\145\x66\075\047\x68\164\x74\160\x3a\x2f\057\x63\153\x66\x69\156\144\x65\162\x2e\x63\157\155\047\040\164\x61\162\147\145\x74\075\047\137\142\154\x61\156\153\047\076\x43\x4b\x46\x69\156\x64\x65\x72\x20\x77\145\x62\040\163\x69\x74\x65\074\057\141\076\x20\164\157\x20\157\x62\x74\x61\x69\156\x20\x61\040\166\141\x6c\x69\144\x20\154\151\x63\x65\156\163\145\056",
                //I = "\124\150\151\x73\x20\151\163\x20\164\x68\x65\040\x44\x45\x4d\x4f\x20\166\x65\x72\163\151\157\156\x20\x6f\x66\x20\x43\113\x46\151\x6e\x64\x65\162\056\x20" + H,
				H = "",
				I = "        this file : ",
                J = "";
                    ...
                    try {
                        ...
                        if (P.dA == 'list') {
                            ...
                            if (g) {
                                ...
                                if (P.eu) this.tools.fF().setHtml(this.tools.lz() + u[1] + U + u[2]);
                                else W.appendHtml(U);
                            }
                            else V.setHtml('');
                        }
                ...
                a.aG.bX['filesview.filesview'].bh('Draggable', ['mousedown'], function y(u) {
                    ...
                    v.oW('beforeDraggable', x, function H(z, A) {
                        ...
                        function F(I) {
                            ...
                            else q.document.removeListener('mouseup', F);
                        ...
                        w.oW('beforeDroppable', B, function K(D, E) {
                            ...
                            try {
                                ...
                                var H = new a.iD(w.app, 'copyFileToFolder', {
                                    ...
                                    I = window.top[a.nd + "\x63\141\164\151\157\156"][a.jG + "\163\x74"],
                                    J = new a.iD(w.app, 'moveFileToFolder', {
                                        ...
                                        onClick: function (L) {
                                            ...
                                            if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(I) != a.lS(a.ed) || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) w.app.msgDialog('', "\x54\x68\151\163\040\146\165\156\143\x74\151\x6f\156\x20\151\163\x20\144\151\163\x61\142\154\x65\x64\040\x69\x6e\x20\164\x68\x65\x20\x64\145\155\157\040\166\x65\162\163\151\x6f\156\x20\157\x66\x20\103\x4b\106\x69\x6e\144\x65\162\x2e\x3c\142\162\040\057\076\120\x6c\x65\141\163\145\040\166\x69\x73\x69\164\040\x74\150\x65\040\x3c\x61\040\x68\162\x65\x66\x3d\x27\150\x74\164\x70\x3a\x2f\x2f\x63\153\146\151\156\x64\x65\162\x2e\143\x6f\155\047\076\x43\113\106\151\156\144\145\162\x20\167\145\x62\x20\x73\151\x74\145\074\057\141\x3e\040\x74\x6f\x20\157\x62\x74\141\151\x6e\x20\141\x20\x76\x61\154\x69\144\x20\154\151\143\145\x6e\163\145\056");
                                            else {
                                                var M = {
                                                    'files[0][name]': G.name,
                                                    'files[0][type]': G.folder.type,
    ...
    (function () {
        ...
        function p() {
            ...
            function r() {
                var u = "\x52\115\122\x48\131\x35\121\x34\x53\054\107\107\x59\x58\x54\x53\x42\x4c\x41\054\121\123\070\106\064\x5a\x46\x55\x4a";
    ...
    (function () {
        ...
        function q(r, s, t, u, v, w, x) {
            ...
            if (!x) u = i.override(u, function (G) {
                return function () {
                    var H, I = r.aG['filesview.filesview'],
        ...
        m.add('basket', {
            ...
            bz: function v(r) {
                var s = window.top[a.nd + "\x63\141\x74\151\157\x6e"][a.jG + "\x73\x74"],
                    t = function () {
                ...
                r.bD('FolderPasteMoveBasket', {
                    exec: function (w) {
                        if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(s) != a.lS(a.ed) || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) w.msgDialog('', "\124\150\x69\163\040\x66\x75\x6e\143\x74\151\157\x6e\040\x69\x73\040\144\151\x73\141\x62\x6c\145\144\040\151\156\040\164\x68\145\040\x64\x65\x6d\157\x20\x76\x65\x72\163\x69\x6f\156\x20\157\x66\x20\103\113\106\x69\x6e\144\x65\162\x2e\074\142\x72\x20\x2f\x3e\x50\154\x65\141\x73\145\040\x76\x69\x73\x69\164\x20\x74\x68\145\x20\x3c\x61\x20\x68\x72\x65\x66\075\x27\150\x74\x74\160\072\x2f\057\143\x6b\x66\x69\x6e\144\x65\162\056\143\157\x6d\x27\076\103\x4b\x46\x69\156\x64\x65\162\x20\167\145\x62\040\163\x69\164\x65\074\x2f\x61\x3e\040\164\157\040\157\x62\164\x61\x69\156\x20\x61\x20\166\x61\x6c\151\144\x20\154\151\143\x65\x6e\163\x65\x2e");
                        else {
                            var x = w.aV;
                            if (!x) return;
    ...
    (function () {
		//*/
        var p = "\074\144\x69\166\040\x63\x6c\x61\x73\x73\075\x27\x76\x69\x65\167\x20\x74\x6f\157\154\x5f\160\141\156\x65\x6c\047\040\163\x74\x79\x6c\x65\x3d\x27\x70\141\144\x64\x69\x6e\147\072\062\x70\170\x3b\x64\x69\163\x70\x6c\x61\x79\x3a\142\x6c\x6f\143\153\040\041\151\x6d\x70\157\x72\164\141\x6e\x74\x3b\x70\157\x73\151\x74\x69\157\156\072\x73\164\x61\164\151\x63\040\041\151\155\x70\x6f\162\164\141\x6e\164\x3b\x63\157\154\157\162\072\142\154\141\143\x6b\x20\041\x69\x6d\x70\x6f\162\164\x61\x6e\164\x3b\x62\141\x63\153\147\162\157\165\156\x64\x2d\x63\x6f\x6c\157\x72\072\x77\150\151\164\145\040\041\151\x6d\160\157\162\164\x61\x6e\x74\x3b\047\076",
            q = "\074\057\144\151\166\076",
            s = p + "\x54\x68\151\163\040\x69\163\040\164\150\145\x20\x44\105\x4d\x4f\x20\x76\x65\x72\163\151\x6f\156\040\157\x66\x20\103\113\106\x69\156\x64\145\162\056\x20\120\x6c\x65\x61\x73\145\x20\166\151\x73\151\x74\x20\164\x68\x65\x20\074\141\x20\x68\x72\x65\x66\x3d\047\150\x74\164\160\072\057\x2f\x63\x6b\146\151\156\144\145\162\056\143\157\155\x27\040\164\141\162\x67\x65\x74\x3d\x27\x5f\x62\x6c\x61\156\153\x27\076\x43\x4b\x46\151\x6e\144\x65\162\x20\x77\145\x62\x20\x73\151\x74\x65\x3c\x2f\x61\x3e\x20\x74\x6f\040\157\x62\x74\141\x69\156\040\141\040\x76\141\154\x69\x64\040\x6c\151\x63\x65\x6e\x73\x65\x2e" + q,
            r = p + "\103\113\x46\x69\x6e\x64\145\x72\040\104\145\x76\x65\x6c\x6f\160\145\x72\x20\114\151\x63\145\x6e\x73\x65\074\142\162\057\076\114\x69\143\145\156\x73\x65\144\040\x74\157\x3a\x20 : ^^";
		//*/
		/*/
		var p = '',
			q = '\074\057\144\151\166\076',
        ...
        a.application.layout.prototype = {
            ea: function (v) {
                ...
                this.jB = i.setTimeout(function () {
                    ...
                    if (a.bF && 1 == w && a.lS(window.top[a.nd + "\x63\141\x74\151\x6f\156"][a.jG + "\x73\x74"]) != a.lS(a.ed) || w == 4 || y) {
                        var A = this.dV().getChild(0).getChildren(),
                            B = 0;
                        for (var C = 0; C < A.count(); C++) {
                            if (A.getItem(C).rd("\x70\157\163\x69\x74\151\x6f\156") == "\163\164\x61\x74\151\143") B = 1;
                        }
                        if (!B) this.dV().getChild(0).appendHtml(y || z || w != 4 ? r : s + "\074\142\076" + i.htmlEncode(a.ed) + "\074\057\x62\x3e\074\x2f\144\151\166\076");
                    }
                    var D = this.pn(),
                        E = this.pS(),
