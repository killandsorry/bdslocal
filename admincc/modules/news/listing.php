...
require_once("inc_security.php");
	...
	$new_cat_id	= $arrayCat_vl;
    $new_pro_id	= $arrrayProducts;
		/*
    ...
    $list->add('new_title', translate_text("Seo title"), "string", 1, 0);
    $list->add('new_description', translate_text("Seo des"), "string", 1, 0);
    $list->add("new_cat_id", "Danh mục", "array", 0, 1, "width='150' align='center'");
    $list->add("new_pro_id","Dự án","array",1,0, 'width="50"');
    $list->add("new_date","Ngày tạo","date",1,0, 'width="100"');
    $list->add("new_active", "Acitve", "checkbox", 1, 0);
