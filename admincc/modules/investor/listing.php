...
require_once("inc_security.php");
    ...
    */
    ...
    $list->add("inv_full_address", "Địa chỉ", "str", 0, 1, "");
    $list->add("inv_home_phone","ĐT bàn","str",1,0, 'width="50"');
    $list->add("inv_hot_line","Hotline","str",1,0, 'width="50"');
    $list->add("inv_email","Email","str",1,0, '');
    $list->add("inv_website","Website","str",1,0, '');
    $list->add("inv_title","Seo title","str",1,0, '');
    $list->add("inv_description","Seo des","str",1,0, '');
    $list->add("inv_active", "Acitve", "checkbox", 1, 0);
