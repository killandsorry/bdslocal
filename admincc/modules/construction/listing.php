...
require_once("inc_security.php");
    ...
    */
    ...
    $list->add("con_full_address", "Địa chỉ", "str", 0, 1, "");
    $list->add("con_home_phone","ĐT bàn","str",1,0, 'width="50"');
    $list->add("con_hot_line","Hotline","str",1,0, 'width="50"');
    $list->add("con_email","Email","str",1,0, '');
    $list->add("con_website","Website","str",1,0, '');
    $list->add("con_title","Seo title","str",1,0, '');
    $list->add("con_description","Seo des","str",1,0, '');
    $list->add("con_active", "Acitve", "checkbox", 1, 0);
